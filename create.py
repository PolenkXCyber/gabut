...
<center>
<h1><center><font color=\"red\" face=Iceland>"""
...
var j=0
var texteNE, affiche
var texte=\"<br><br><br><br><br><font face=Iceland color="""
...
affiche='<font face=Iceland size=1 color=#ffffff><strong>Messenge : '+texteNE+'</strong></font>'
if (texte.charAt(i)=="<") {
j=1
}
if (texte.charAt(i)==">") {
...
</script><font face="Iceland" size="1"><blink><span style="color: rgb(255, 255, 255);"><b><font color=red size=4></font></b></u></blink><br></font></b>
